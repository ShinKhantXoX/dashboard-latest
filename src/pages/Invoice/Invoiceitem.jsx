...
const Invoiceitem = () => {
  return (
    <div className=" pb-32">
      ...
      <div className=" p-[20px] bg-white w-[80%] mx-auto md:w-[93%] shadow-lg lg:ml-[50px] md:ml-[50px] mt-[40px]">
        <div className=" w-[90%] mx-auto">
          ...
          <div className=" flex gap-3 md:gap-10 mt-[30px]  lg:w-[45%] w-[80%] md:w-[45%] ">
            {/* client */}
            <div className="flex flex-col gap-1 font-semibold  lg:w-[45%] w-[80%] md:w-[45%]">
              {" "}
              ...
              <p className=" text-blue-500 text-[10px] md:text-[13px] w-[80%] md:w-[100%]">chris.wood@gmail.com</p>
            </div>

            <div className="flex flex-col gap-1 font-semibold lg:w-[45%] w-[50%] md:w-[45%]">
              {" "}
              ...
              <p className=" text-gray-400 text-[13px]">USA</p>
              <p className=" text-blue-500 text-[10px] md:text-[13px] w-[50%] md:w-[100%]">
