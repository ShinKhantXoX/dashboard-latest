...
const Account = () => {
  return (
    <div className="  flex flex-col gap-10 w-[100%]">
      <div className=" flex lg:flex-row md:flex-row flex-col justify-between gap-[50px]  w-[80%] md:w-[100%] mx-auto  bg-white shadow-lg p-10 ">
      ...
      <form className=" mt-[5px]  w-[80%] md:w-[100%] mx-auto   bg-white shadow-lg p-10">
